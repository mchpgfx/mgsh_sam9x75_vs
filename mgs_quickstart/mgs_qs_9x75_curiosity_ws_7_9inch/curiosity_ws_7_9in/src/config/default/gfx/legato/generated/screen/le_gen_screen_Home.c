...
leResult screenShow_Home(void)
{
    ...
    Home_BackgroundPanel->fn->setSize(Home_BackgroundPanel, 1280, 400);
    ...
    Home_ImageWidgetMGSLogo->fn->setPosition(Home_ImageWidgetMGSLogo, 16, 320);
    ...
    Home_ButtonWidgetQuickStart->fn->setPosition(Home_ButtonWidgetQuickStart, 1024, 320);
    ...
    Home_LabelWidget_0->fn->setPosition(Home_LabelWidget_0, 313, 141);
    ...
    Home_LabelWidget_1->fn->setPosition(Home_LabelWidget_1, 509, 141);
    ...
    Home_LabelWidget_2->fn->setPosition(Home_LabelWidget_2, 716, 140);
