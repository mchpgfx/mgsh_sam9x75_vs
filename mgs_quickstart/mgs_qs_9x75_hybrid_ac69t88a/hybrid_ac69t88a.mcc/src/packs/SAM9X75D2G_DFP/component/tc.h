...
#define   TC_CMR_CAPTURE_TCCLKS_TIMER_CLOCK1_Val _UINT32_(0x0)                                        /* (TC_CMR) Clock selected: internal GCLK [17], GCLK[45] clock signal (from PMC)  */
...
#define TC_CMR_CAPTURE_TCCLKS_TIMER_CLOCK1    (TC_CMR_CAPTURE_TCCLKS_TIMER_CLOCK1_Val << TC_CMR_CAPTURE_TCCLKS_Pos) /* (TC_CMR) Clock selected: internal GCLK [17], GCLK[45] clock signal (from PMC) Position */
...
#define   TC_CMR_WAVEFORM_TCCLKS_TIMER_CLOCK1_Val _UINT32_(0x0)                                        /* (TC_CMR) Clock selected: internal GCLK [17], GCLK[45] clock signal (from PMC)  */
...
#define TC_CMR_WAVEFORM_TCCLKS_TIMER_CLOCK1   (TC_CMR_WAVEFORM_TCCLKS_TIMER_CLOCK1_Val << TC_CMR_WAVEFORM_TCCLKS_Pos) /* (TC_CMR) Clock selected: internal GCLK [17], GCLK[45] clock signal (from PMC) Position */
