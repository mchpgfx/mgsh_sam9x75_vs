...
leResult screenShow_Home(void)
{
    ...
    Home_BackgroundPanel->fn->setSize(Home_BackgroundPanel, 720, 720);
    ...
    Home_ImageWidgetMCHPLogo->fn->setPosition(Home_ImageWidgetMCHPLogo, 260, 164);
    ...
    Home_ButtonWidgetQuickStart->fn->setPosition(Home_ButtonWidgetQuickStart, 253, 576);
    ...
    Home_LabelWidget_0->fn->setPosition(Home_LabelWidget_0, 272, 228);
    ...
    Home_LabelWidget_1->fn->setPosition(Home_LabelWidget_1, 265, 334);
    ...
    Home_LabelWidget_2->fn->setPosition(Home_LabelWidget_2, 240, 433);
    ...
    Home_ImageWidgetMGSLogo->fn->setPosition(Home_ImageWidgetMGSLogo, 240, 47);
